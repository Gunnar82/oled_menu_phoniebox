...
if [ "${DEBUG_inc_writeFolderConfig_sh}" == "TRUE" ]; then echo "VAR COMMAND: $COMMAND" >> $PATHDATA/../logs/debug.log; fi
if [ "${DEBUG_inc_writeFolderConfig_sh}" == "TRUE" ]; then echo "VAR FOLDER: $FOLDER" >> $PATHDATA/../logs/debug.log; fi
if [ "${DEBUG_inc_writeFolderConfig_sh}" == "TRUE" ]; then echo "VAR AUDIOFOLDERSPATH: $AUDIOFOLDERSPATH" >> $PATHDATA/../logs/debug.log; fi


if [ "${DEBUG_inc_writeFolderConfig_sh}" == "TRUE" ]; then echo "CHECK FOLDER EXISTS: ${AUDIOFOLDERSPATH}/${FOLDER}" >> $PATHDATA/../logs/debug.log; fi
...
then
    ...
    then
        if [ "${DEBUG_inc_writeFolderConfig_sh}" == "TRUE" ]; then echo "  !!!setting default vars for raw create!!!" >> $PATHDATA/../logs/debug.log; fi
        # set default vars
    ...
    if [ "${DEBUG_inc_writeFolderConfig_sh}" == "TRUE" ]; then echo "  content of ${AUDIOFOLDERSPATH}/${FOLDER}/folder.conf" >> $PATHDATA/../logs/debug.log; fi
    if [ "${DEBUG_inc_writeFolderConfig_sh}" == "TRUE" ]; then cat "${AUDIOFOLDERSPATH}/${FOLDER}/folder.conf" >> $PATHDATA/../logs/debug.log; fi
    ...
    sudo sed -i 's/%PLAYSTATUS%/'"Stopped"'/' "${AUDIOFOLDERSPATH}/${FOLDER}/folder.conf"
