...
def main():
    ...
    loadedwins.append(windows.idle.Idle(windowmanager, loop, _nowplaying,mopidy))
    loadedwins.append(windows.playbackmenu.Playbackmenu(windowmanager, loop, _nowplaying,mopidy))
    ...
    loadedwins.append(windows.foldermenu.Foldermenu(windowmanager,loop, mopidy))
    ...
    loadedwins.append(windows.ende.Ende(windowmanager, loop,_nowplaying,mopidy))
    ...
    loadedwins.append(wlock.Lock(windowmanager,loop,_nowplaying,mopidy))
