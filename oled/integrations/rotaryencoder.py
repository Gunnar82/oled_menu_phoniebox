...
class RotaryEncoder():
    ...
    def _rotary_turn(self, channel):
        ...
        print ("a:" +  str(switch_a))
        print ("b:" + str(switch_b))
    ...
    def _setup_gpio(self, clk_pin, dt_pin, sw_pin):
        ...
        #Rotary encoder
        GPIO.add_event_detect(clk_pin, GPIO.RISING, callback=self._rotary_turn, bouncetime=250)
        #GPIO.add_event_detect(dt_pin, GPIO.RISING, callback=self._rotary_turn,bouncetime=250)
        #Push Button
